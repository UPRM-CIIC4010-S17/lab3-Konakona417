...
//                        g.drawLine(x1+width, y1, x1, height);
...
//                        g.fillPolygon(p);
                        ...
                        //Random excercises up there, flag begins now
                        ...
                        //Draw white stripes
                        g.setColor(Color.WHITE);
                        g.fillRect(x1 + 42, y1 + 40, 178, 30);
                        g.fillRect(x1 + 42, y1 + 98, 178, 30);
                        
                        //Draw triangle
                        Polygon p3 = new Polygon();
                        p3.addPoint(x1 + 10, y1 + 9);
